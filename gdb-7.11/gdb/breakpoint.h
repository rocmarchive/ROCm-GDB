...
struct breakpoint
  {
    ...
    /* For a GPU breakpoint, the request that is used to create
...
extern void create_hsa_gpu_breakpoint_trigger (const char *location);

extern void delete_hsa_agent_internal_breakpoint(void);
